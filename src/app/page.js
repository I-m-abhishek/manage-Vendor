...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-20 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-[F7FCFF] dark:bg-gray-800">
      <ul class=" flex flex-col justify-center items-centerspace-y-2 font-medium">
        <li >
...
<line x1="1.5" y1="-6.55671e-08" x2="1.5" y2="13" stroke="#ED0505" stroke-width="3"/>
